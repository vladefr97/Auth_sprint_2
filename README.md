...
[tatitrif](https://github.com/tatitrif)

## Используемые технологии

- Сервис авторизации с системой ролей, написанный на **Flask + gevent**
- Приложение Python **WSGI** запускается под управлением сервера **gunicorn** на **Nginx**
